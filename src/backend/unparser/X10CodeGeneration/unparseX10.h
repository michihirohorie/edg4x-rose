...
class Unparse_X10 : public UnparseLanguageIndependentConstructs
   {
     public:
          Unparse_X10(Unparser* unp, std::string fname);

          virtual ~Unparse_X10();

          void unparseX10File(SgSourceFile *file, SgUnparse_Info &info);
      ...
      //! Unparser support for compiler-generated statments
       ...
       // these need X10-specific treatment
...
//          virtual void unparseDeclarationModifier2   (SgDeclarationModifier& mod,   SgUnparse_Info& info);
      ...
      //! Support for unparsing types
          ...
          void unparseLambdaExpression(SgExpression *, SgUnparse_Info& info);
          void unparseLambdaRefExpression(SgExpression *, SgUnparse_Info& info);
